...
- [Dashboard General](./dashboard) - Métricas principales y resúmenes
- [Estadísticas por Entidad](./entidades) - Análisis por EPS
- [Análisis de Oportunidad](./oportunidad) - Tiempos y SLA
- [Rendimiento de Patólogos](./patologos) - Productividad especialistas
- [Estadísticas por Pruebas](./pruebas) - Análisis de exámenes
